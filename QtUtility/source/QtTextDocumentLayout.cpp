...
static QPen qPenFromStyle(const QBrush& b,qreal width,QCss::BorderStyle s) {
...
void qDrawEdge(QPainter *p,qreal x1,qreal y1,qreal x2,qreal y2,qreal dw1,qreal dw2,
    ...
    switch (style) {
        ...
        case BorderStyle_Double: {
            ...
            switch (edge) {
                case TopEdge:
                    private_::qDrawEdge(p,x1,y1,x2,y1+wby3,dw1by3,dw2by3,TopEdge,BorderStyle_Solid,c);
                    private_::qDrawEdge(p,x1+dw1-dw1by3,y2-wby3,x2-dw2+dw1by3,y2,
                        dw1by3,dw2by3,TopEdge,BorderStyle_Solid,c);
                    break;
                case LeftEdge:
                    private_::qDrawEdge(p,x1,y1,x1+wby3,y2,dw1by3,dw2by3,LeftEdge,BorderStyle_Solid,c);
                    private_::qDrawEdge(p,x2-wby3,y1+dw1-dw1by3,x2,y2-dw2+dw2by3,dw1by3,dw2by3,
                        LeftEdge,BorderStyle_Solid,c);
                    break;
                case BottomEdge:
                    private_::qDrawEdge(p,x1+dw1-dw1by3,y1,x2-dw2+dw2by3,y1+wby3,dw1by3,dw2by3,
                        BottomEdge,BorderStyle_Solid,c);
                    private_::qDrawEdge(p,x1,y2-wby3,x2,y2,dw1by3,dw2by3,BottomEdge,BorderStyle_Solid,c);
                    break;
                case RightEdge:
                    private_::qDrawEdge(p,x2-wby3,y1,x2,y2,dw1by3,dw2by3,RightEdge,BorderStyle_Solid,c);
                    private_::qDrawEdge(p,x1,y1+dw1-dw1by3,x1+wby3,y2-dw2+dw2by3,dw1by3,dw2by3,
        ...
        case BorderStyle_Groove: {
            ...
            switch (edge) {
                case TopEdge:
                    private_::qDrawEdge(p,x1,y1,x2,y1+wby2,dw1by2,dw2by2,TopEdge,s1,c);
                    private_::qDrawEdge(p,x1+dw1by2,y1+wby2,x2-dw2by2,y2,dw1by2,dw2by2,TopEdge,s2,c);
                    break;
                case BottomEdge:
                    private_::qDrawEdge(p,x1,y1+wby2,x2,y2,dw1by2,dw2by2,BottomEdge,s1,c);
                    private_::qDrawEdge(p,x1+dw1by2,y1,x2-dw2by2,y1+wby2,dw1by2,dw2by2,BottomEdge,s2,c);
                    break;
                case LeftEdge:
                    private_::qDrawEdge(p,x1,y1,x1+wby2,y2,dw1by2,dw2by2,LeftEdge,s1,c);
                    private_::qDrawEdge(p,x1+wby2,y1+dw1by2,x2,y2-dw2by2,dw1by2,dw2by2,LeftEdge,s2,c);
                    break;
                case RightEdge:
                    private_::qDrawEdge(p,x1+wby2,y1,x2,y2,dw1by2,dw2by2,RightEdge,s1,c);
                    private_::qDrawEdge(p,x1,y1+dw1by2,x1+wby2,y2-dw2by2,dw1by2,dw2by2,RightEdge,s2,c);
                    break;
                default:
                    break;
            }
...
{
    Q_DECLARE_PUBLIC(QtTextDocumentLayout)
public:
    ...
    void drawBorder(
        ...
        const QtTextDocumentLayout * super = q_func();
        super->drawBorder(painter,rect,topMargin,bottomMargin,border,brush,style);
    }
...
void QTextDocumentLayoutPrivate::__drawBorder(
    QPainter *painter, 
    const QRectF &rect, 
    qreal topMargin, 
    qreal bottomMargin,
    ...
    QTextFrameFormat::BorderStyle style) const
{
    ...
    for (int i = topPage; i <= bottomPage; ++i) {
        ...
        q_func()->drawBorderDetail(painter,style,clipped,border,brush);
...
//     INC_INDENT;
    ...
    if (table) {
        ...
        if (frame==document->rootFrame()/*document->rootFrame()*/) {
...
{
    Q_Q(const QtTextDocumentLayout);
    ...
    for (int i = 0; i < floats.count(); ++i) {
        ...
        QTextCharFormat format = const_cast<QtTextDocumentLayout *>(q)->format(pos);
...
QtTextDocumentLayout::QtTextDocumentLayout(QTextDocument *doc)
...
void QtTextDocumentLayout::draw(QPainter *painter, const PaintContext &context)
{
...
void QtTextDocumentLayout::setViewport(const QRectF &viewport)
{
    Q_D(QTextDocumentLayout);
...
void QtTextDocumentLayout::documentChanged(int from, int oldLength, int length)
{
    Q_D(QTextDocumentLayout);
...
QRectF QtTextDocumentLayout::doLayout(int from, int oldLength, int length)
{
    Q_D(QTextDocumentLayout);
...
int QtTextDocumentLayout::hitTest(const QPointF &point, Qt::HitTestAccuracy accuracy) const
{
...
void QtTextDocumentLayout::resizeInlineObject(QTextInlineObject item, int posInDocument, const QTextFormat &format)
{
    Q_D(QTextDocumentLayout);
...
void QtTextDocumentLayout::positionInlineObject(QTextInlineObject item, int posInDocument, const QTextFormat &format)
{
    Q_D(QTextDocumentLayout);
...
void QtTextDocumentLayout::drawInlineObject(QPainter *p, const QRectF &rect, QTextInlineObject item,
...
int QtTextDocumentLayout::dynamicPageCount() const
{
    Q_D(const QTextDocumentLayout);
...
QSizeF QtTextDocumentLayout::dynamicDocumentSize() const
{
    Q_D(const QTextDocumentLayout);
    return data(d->document->rootFrame())->size.toSizeF();
}

int QtTextDocumentLayout::pageCount() const
{
    Q_D(const QTextDocumentLayout);
    d->ensureLayoutFinished();
...
QSizeF QtTextDocumentLayout::documentSize() const
{
    Q_D(const QTextDocumentLayout);
    d->ensureLayoutFinished();
...
void QTextDocumentLayoutPrivate::ensureLayoutedByPosition(int position) const
{
    ...
    while (currentLazyLayoutPosition != -1
        ...
        const_cast<QtTextDocumentLayout *>(q_func())->doLayout(currentLazyLayoutPosition, 0, INT_MAX - currentLazyLayoutPosition);
    }
}
...
void QtTextDocumentLayout::setCursorWidth(int width)
{
    Q_D(QTextDocumentLayout);
    d->cursorWidth = width;
}

int QtTextDocumentLayout::cursorWidth() const
{
    Q_D(const QTextDocumentLayout);
    return d->cursorWidth;
}

void QtTextDocumentLayout::setFixedColumnWidth(int width)
{
    Q_D(QTextDocumentLayout);
    d->fixedColumnWidth = width;
}

QRectF QtTextDocumentLayout::tableCellBoundingRect(QTextTable *table, const QTextTableCell &cell) const
{
    if (!cell.isValid())
        return QRectF();
...
QRectF QtTextDocumentLayout::tableBoundingRect(QTextTable *table) const
{
    Q_D(const QTextDocumentLayout);
    if (d->docPrivate->pageSize.isNull())
        return QRectF();
...
QRectF QtTextDocumentLayout::frameBoundingRect(QTextFrame *frame) const
{
    Q_D(const QTextDocumentLayout);
    if (d->docPrivate->pageSize.isNull())
        return QRectF();
...
QRectF QtTextDocumentLayout::blockBoundingRect(const QTextBlock &block) const
{
    Q_D(const QTextDocumentLayout);
...
int QtTextDocumentLayout::layoutStatus() const
{
    Q_D(const QTextDocumentLayout);
...
void QtTextDocumentLayout::timerEvent(QTimerEvent *e)
{
    Q_D(QTextDocumentLayout);
...
void QtTextDocumentLayout::layoutFinished()
{
    Q_D(QTextDocumentLayout);
    d->layoutTimer.stop();
...
void QtTextDocumentLayout::ensureLayouted(qreal y)
{
    d_func()->ensureLayouted(QFixed::fromReal(y));
}

qreal QtTextDocumentLayout::idealWidth() const
{
    Q_D(const QTextDocumentLayout);
    d->ensureLayoutFinished();
    return d->idealWidth;
...
bool QtTextDocumentLayout::contentHasAlignment() const
{
    Q_D(const QTextDocumentLayout);
...
void QtTextDocumentLayout::drawBorderDetail(
    QPainter * painter,
    ...
    private_::qDrawEdge(painter, clipped.left(), clipped.top(), clipped.left() + border, clipped.bottom() + border, 0, 0, QCss::LeftEdge, cssStyle, brush);
    private_::qDrawEdge(painter, clipped.left() + border, clipped.top(), clipped.right() + border, clipped.top() + border, 0, 0, QCss::TopEdge, cssStyle, brush);
    private_::qDrawEdge(painter, clipped.right(), clipped.top() + border, clipped.right() + border, clipped.bottom(), 0, 0, QCss::RightEdge, cssStyle, brush);
    private_::qDrawEdge(painter, clipped.left() + border, clipped.bottom(), clipped.right() + border, clipped.bottom() + border, 0, 0, QCss::BottomEdge, cssStyle, brush);

}

void QtTextDocumentLayout::drawBorder(
    QPainter *painter,
    const QRectF &rect,
    qreal topMargin,
    qreal bottomMargin,
    ...
    QTextFrameFormat::BorderStyle style) const {
    Q_D(const QTextDocumentLayout);
    d->__drawBorder(painter,rect,topMargin,bottomMargin,border,brush,style);
}
